...
void vtkploting(QVTKWidget vtkwidget)
{
    ...
    vtkSmartPointer<vtkRenderWindow> renWin = vtkSmartPointer<vtkRenderWindow>::New();      				//----���û��ƴ���
        renWin->AddRenderer(ren);
        renWin->SetSize(800,800);
    \
    vtkSmartPointer<vtkRenderWindowInteractor> iren = vtkSmartPointer<vtkRenderWindowInteractor>::New();	//----���û��ƽ����������ڵ�
    ...
    chrono::duration<double> delay_time = chrono::duration_cast<chrono::duration<double>>(t2 - t1); //milliseconds ����

    cout<<"耗时:"<<delay_time.count()<<"秒"<<endl;
